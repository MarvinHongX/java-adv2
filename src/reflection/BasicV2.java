...
public class BasicV2 {
    public static void main(String[] args) {
        ...
        System.out.println("Modifier.isPublic(basicDataClass.getModifiers()) = " + Modifier.isPublic(basicDataClass.getModifiers()));
        System.out.println("Modifier.toString(basicDataClass.getModifiers()) = " + Modifier.toString(basicDataClass.getModifiers()));
    }
}